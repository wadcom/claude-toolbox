...
The goal file `goal.html` should contain business-focused explanation of the
initiative's goal. It should contain no technical details (unless the goal is
inherently technical).

**Use this template structure for goal.html**:

````html
<h1>[Feature/Task Name]</h1>

<h2>Purpose</h2>

<p>[Brief description of what we're implementing and why]</p>
...
<p>[Brief, high-level description of the solution]</p>

<h2>Use Case Example</h2>

<p>[Examples of how the solution solves the problem]</p>

<h2>Scope</h2>

<p>[High-level description of all system parts that need work to implement
the solution]</p>

<p>[Things explicitly out of scope]</p>

<h2>Success Criteria</h2>

<p>[How success looks, besides what's listed in Use Case Example]</p>

<h2>References</h2>

<p>[Any documents, files or links that provide context for the initiative]</p>
````

## Spec File

### Every Spec Must Include:
1. **Overview** - 2-4 sentences linking to goal.html
...
Both `goal.html` and `spec.html` must be structured as linear walkthroughs.
...
- [ ] No business requirements (→ goal.html)
- [ ] No step-by-step instructions (→ backlog)
- [ ] Senior dev could implement without constant questions

## Common Pitfalls

1. Mixing business rationale with technical details (business → goal.html)
